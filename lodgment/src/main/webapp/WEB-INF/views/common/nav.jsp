...
<nav class="navbar navbar-expand-md sticky-top bg-info navbar-dark">
	<div class="nav-container px-3">
		<!-- 홈버튼 -->
		<a class="navbar-brand" href="/">
      		<img src="/resources/images/logo.png" alt="" width="100" height="auto">
    	</a>
		<ul class="navbar-nav">			
			<div class="container-fluid position-relative" style="width:700px;height:auto">
   				<form id="nav-form-search" class="d-flex justify-content-center my-auto" action="/near" autocomplete="off">

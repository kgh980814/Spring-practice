						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"
									value="${news.regdate }"></fmt:formatDate>
							</div>
						</div>

						<div class="row">
							<div class="col-sm-9 col-sm-offset-3">
								<a href="modify?bno=${news.bno }" class="btn btn-danger btn-sm">Modify
									Button</a>
...
function getList() {
		$.ajax({
			...
			url : "/admin/replies/pages/${news.bno }/"+pageNum+".json", // 컨트롤러에서 대기중인 URL 주소이다.
